...
class TextBlock:
    """文本块信息"""
    def __init__(self, text: str, page_num: int, confidence: float = 0.9):
        self.text = text
        self.page_num = page_num
        self.confidence = confidence

class PDFTextExtractor:
    """PDF文本抽取器 - 只负责提取文本，不进行分析"""
        ...
        try:
            ...
            for page_idx in range(total_pages):
                ...
                try:
                    ...
                    page_blocks = self._extract_text_from_page(page, page_num)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="PDF文本抽取工具")
